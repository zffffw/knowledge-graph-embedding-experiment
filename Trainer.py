...
class Trainer:
    def __init__(self, params, model_name, train_data_loader, valid_data_loader, model, \
        loss, optimizer, times=100, use_GPU=True, check_step = 10, save_step = 20):
    ...
    def train_one_step(self, h, r, t):
        ...
        p_score, n_score = self.model(h, r, t, int(h.shape[0] / 2))
    ...
    def valid_model(self, epochs, train_loss):
        ...
        for data_val in self.valid_data_loader:
            ...
            p_score, n_score = self.model(batch_h, batch_r, batch_t, int(h.shape[0] / 2))
